...
- id: 680595
  ...
  content: 'RT @DataG: New blog post: The Who, What, When, Where and Why of Library
    Discovery (#NISOforum closing keynote text) http://t.co/yZdbBnpZlJ'
---
<p>[caption id="attachment_KkOCeAtKHIc" align="alignright" width="210" caption="Me and my Jester's Cap"]<br />
...
{{ captioned(
    div_float="center",
    width="570",
    caption="'Introducing Amazon Echo' -- the first one minute and 25 seconds were played in the presentation",
    contents='<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/KkOCeAtKHIc?rel=0" frameborder="0"></iframe>') }}
