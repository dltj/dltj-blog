...
<div style="float:right;border:1px solid #CCC; margin:0 0 1.5em 2.5em; padding: .75em; width:35%;"><a href="/assets/images/2008/02/airport-advanced-settings-proxy.png" title="MacOSX 10.5 Proxy screen"><img src="/assets/images/2008/02/airport-advanced-settings-proxy.png" alt="MacOSX 10.5 Proxy screen" /></a></div>
