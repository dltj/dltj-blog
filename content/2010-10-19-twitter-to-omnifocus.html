...
<pre>  chmod u+x twitter-to-omnifocus</pre>
<pre>  ./twitter-to-omnifocus</pre>
<p>You'll be promted to go to a website to get a PIN:</p>
<pre>  Authorize this app at http://twitter.com/oauth/authorize?oauth_token=nnn and enter the PIN#</pre>
...
<p>The last step is to get the script to run periodically on the Mac.  If one were to stick to UNIX traditions, you would run `crontab -e` to create a cron entry.  I think that would work, but the Mac-way of doing it is to create a launchd entry.  You can create one of these by hand, but I find using <a href="http://sourceforge.net/projects/lingon/" title="Lingon | SourceForge.net">Lingon</a> to be a much more palatable way of doing it.  (Okay -- so I'm not a pure command-line junkie.)<br />[caption id="attachment_1738" align="aligncenter" width="714" caption="Lingon configuration for twitter-to-omnifocus"]<a href="/wp-content/uploads/2010/10/Lingon-configuration-for-twitter-to-omnifocus.jpg"><img src="/wp-content/uploads/2010/10/Lingon-configuration-for-twitter-to-omnifocus.jpg" alt="" title="Lingon configuration for twitter-to-omnifocus" width="714" height="732" class="size-full wp-image-1738" /></a>[/caption]</p>
<h2>All Done!</h2>
<p>[caption id="attachment_1742" align="alignright" width="200" caption="iPhone Dragon Dictation screen"]<img src="/wp-content/uploads/2010/10/IMG_0054-200x300.png" alt="" title="Dragon Dictation Screen" width="200" height="300" class="size-medium wp-image-1742" />[/caption]With that set, you can now simply send a tweet to your private Twitter account from any mechanism you might have.  What got me started on this path was using <a href="http://itunes.apple.com/us/app/dragon-dictation/id341446764?mt=8" title="Dragon Dictation for iPhone, iPod touch, and iPad on the iTunes App Store">Dragon Dictation</a> on the iPhone to dictate inbox items.  One person suggested using <a href="http://jott.com/default.aspx" title="Jott.com | Voice-to-Text Notes, To Dos &amp; Reminders.  Voicemail-to-Email and Text Message">Jott</a> for phone-to-Twitter transcribing and another suggested an <a href="http://tweetymail.com/" title="Twitter over Email">e-mail path</a>.</p>
