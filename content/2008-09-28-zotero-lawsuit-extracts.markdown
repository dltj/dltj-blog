...
<li><i>separation of components</i> ([EndNote] Software is licensed as a single product.  <i>Its component parts may not be separated</i> for use on more than one computer);</li>
