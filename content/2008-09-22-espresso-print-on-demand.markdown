...
<p>Espresso 1.5 is modular in 2 parts and measures about 9 feet long, 5 feet high and about five feet deep with printers.  The version 1.5 EBM draws up to about 30 amps at 220 volts. While the 1.5 model is a limited production model, the version 2.0 designed for mass production is in development and will be available first quarter of 2009.  Cost estimates for the machine are not yet available.</p>
