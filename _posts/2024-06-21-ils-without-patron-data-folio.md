...
## New Fee-Fine Module
{: #feefine-module}
Like the FOLIO email notification module, there is a {% include robustlink.html href="https://s3.amazonaws.com/foliodocs/api/mod-feesfines/r/feefines.html" versionurl="https://web.archive.org/web/20240621223053/https://s3.amazonaws.com/foliodocs/api/mod-feesfines/r/feefines.html" versiondate="20240621" title="Feefines version v1 | FOLIO API" anchor="single point" %} that FILP will need to override to send fee/fine information to an external agent. 
...
If your library would like to do this with FOLIO, {% include robustlink.html href="https://www.indexdata.com/" versionurl="https://web.archive.org/web/20240618210912/https://www.indexdata.com/" versiondate="20240618" title="Index Data homepage" anchor="Index Data" %} specializes in this type of software development. 
